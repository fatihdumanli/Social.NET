...
namespace SocialMediaSharing.BLL.TwitterAPI
{
   public class TwitterAPIClient : ITwitterAPIClient
   {
      ...
      {
         ConsumerKey = _configuration["AppSettings:TwitterConsumerKey"];
         ConsumerSecret = _configuration["AppSettings:TwitterConsumerSecret"];
      }

      public TwitterAPIClient(IAPILibLogger logger, IConfiguration configuration)
      {
         _logger = logger;
